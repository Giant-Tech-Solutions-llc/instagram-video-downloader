      ...
      <main className="flex-grow">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-[#E6195E]/5 text-[#E6195E] text-[10px] sm:text-xs font-black uppercase tracking-wider mb-4 sm:mb-8 border border-[#E6195E]/10">
                ...
                Baixar Áudio do Instagram Online Grátis
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-3xl mx-auto mb-2 sm:mb-3 font-bold leading-relaxed px-2">
                Baixador de Áudio do Instagram Grátis – Extraia MP3 de Qualquer Link do Instagram
              </p>
            ...
            >
                    ...
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          setUrl(text);
                          toast({ title: "Link colado!", description: "Agora clique em Extrair para processar." });
                        } catch {
              ...
              <div className="mt-4 sm:mt-6 md:mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-black/20">
                ...
                <div className="flex gap-2 sm:gap-4 items-center">
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Extraia música, voz ou som do Instagram</span>
                  <span className="text-black/10">|</span>
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Sem necessidade de instalar aplicativo</span>
                  <span className="text-black/10">|</span>
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Funciona em Android, iPhone, PC, Mac e tablets</span>
                </div>
              </div>
            </motion.div>
          </div>
                      ...
                      {processMutation.data.items!.map((item, index) => (
                        <div key={index} className="bg-card rounded-xl sm:rounded-2xl border border-border/60 shadow-lg overflow-hidden">
                          ...
                          <div className="p-2 sm:p-3">
                            <a
                              href={`/api/proxy-download?url=${encodeURIComponent(item.url)}&filename=${encodeURIComponent(item.filename || `instagram-audio-${index + 1}.mp3`)}`}
                    ...
                    <div className="p-6 sm:p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                      <div className="mb-6 sm:mb-8 text-center md:text-left">
                        ...
                        <p className="text-muted-foreground text-sm sm:text-base md:text-lg">
                          Seu áudio foi extraído com sucesso e está pronto para baixar.
                        </p>
                      </div>
                      <div className="space-y-3 sm:space-y-4">
                        <a
                          href={`/api/proxy-download?url=${encodeURIComponent(processMutation.data.url)}&filename=${encodeURIComponent(processMutation.data.filename || "instagram-audio.mp3")}`}
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {tools.filter(t => t.id !== "audio" && t.slug !== "/").map((t) => (
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-[#F8F9FA]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight mb-4 sm:mb-6">
                Baixar Áudio de Vídeos, Reels, Stories <span className="text-[#E6195E]">e DMs do Instagram</span>
              </h2>
            </div>
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-muted-foreground font-medium leading-relaxed text-center">
              <p>
                O Instagram está repleto de músicas, sons, podcasts, narrações e áudios virais em Reels, Stories, vídeos e mensagens diretas. Muitos usuários desejam baixar o áudio desses conteúdos para ouvir offline, usar em projetos ou simplesmente salvar suas faixas favoritas.
              </p>
              <p>
                No entanto, o Instagram não oferece uma opção nativa para baixar apenas o áudio de vídeos, Reels ou Stories.
              </p>
              <p className="font-bold text-[#1A1A1A]">
                Nosso Baixador de Áudio do Instagram funciona como um extrator completo de áudio e conversor para MP3, permitindo que você:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 my-6 sm:my-8 max-w-2xl mx-auto">
                {[
                  "Baixar áudio do Instagram online",
                  "Extrair áudio de vídeo do Instagram",
                  "Baixar áudio de Reels do Instagram",
                  "Converter vídeo do Instagram em MP3",
                  "Baixar áudio de Story do Instagram",
                  "Baixar mensagens de voz do Instagram Direct",
                  "Baixar áudio do Instagram sem marca d'água",
                  "Salvar som do Instagram no seu dispositivo",
                  "Baixar áudio do Instagram grátis",
                ].map((item, i) => (
              ...
              <p>
                Se você pesquisou por "baixar áudio do Instagram", "extrair MP3 do Instagram", "converter vídeo do Instagram para áudio" ou "Instagram audio downloader", esta página oferece exatamente a ferramenta que você precisa.
              </p>
              <p className="font-bold text-[#1A1A1A]">
                Basta copiar o URL do Instagram e converter o arquivo de mídia em áudio MP3 instantaneamente.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              <span className="text-[#E6195E] font-black uppercase tracking-[0.2em] text-xs sm:text-sm mb-3 sm:mb-4 block">Mais do Que um Extrator de Áudio do Instagram</span>
              ...
              <p className="text-base sm:text-lg text-muted-foreground mt-4 sm:mt-6 max-w-3xl mx-auto font-medium">
                Nossa plataforma não é apenas um simples extrator de áudio. É uma ferramenta completa para baixar conteúdo do Instagram, cobrindo todos os principais formatos:
              </p>
            </div>
            ...
            <p className="text-center text-muted-foreground text-sm sm:text-base font-medium mt-8 max-w-3xl mx-auto">
              Isso torna nosso site uma solução completa para baixar áudio do Instagram, converter vídeos para MP3 e baixar todos os outros tipos de conteúdo do Instagram em uma única plataforma segura.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                Como Baixar Áudio <span className="text-[#E6195E]">do Instagram</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 max-w-2xl mx-auto font-medium">
                Se você está se perguntando como extrair áudio do Instagram, siga estes passos simples:
              </p>
            </div>

            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16">
              {[
                { step: "01", title: "Copie o Link do Vídeo/Reel/Story", desc: "Abra o Instagram e acesse o vídeo, Reel ou Story desejado. Toque nos três pontos e selecione \"Copiar link\"." },
                { step: "02", title: "Cole no Baixador de Áudio", desc: "Volte para nossa ferramenta de extração de áudio do Instagram e cole a URL no campo de download." },
                { step: "03", title: "Clique em Extrair Áudio", desc: "O áudio será extraído instantaneamente e estará pronto para baixar em formato MP3." },
              ].map((item, i) => (
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
              {[
                ...
                "Salvar música de Reels",
                "Converter Reel para áudio",
                "Baixar clipe de voz de Story",
              ].map((item, i) => (
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-2xl sm:rounded-[2rem] border border-black/5 p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-black text-[#1A1A1A] mb-4">
                Como Baixar Áudio do Instagram no Android, iPhone ou PC
              </h3>
              <p className="text-sm sm:text-base text-muted-foreground font-medium mb-4">
                Para baixar áudio do Instagram no celular ou computador sem instalar aplicativo:
              </p>
              <div className="space-y-2.5">
                {[
                  "Abra o aplicativo do Instagram.",
                  "Vá até o vídeo, Reel ou Story com o áudio desejado.",
                  "Toque nos três pontos e selecione \"Copiar link\".",
                  "Abra o navegador e acesse nosso extrator de áudio.",
                  "Cole o link no campo de download.",
                  "Clique em Extrair e baixe o áudio em MP3.",
                ].map((step, i) => (
              ...
              <p className="text-sm text-muted-foreground font-bold mt-4 pt-4 border-t border-black/5">
                Sem aplicativo. Sem extensão de navegador. Sem necessidade de login no Instagram.
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground font-medium mt-2">
                Funciona como um extrator de áudio do Instagram baseado em navegador — rápido, seguro e fácil de usar.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16 md:mb-24">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black mb-4 sm:mb-6 leading-tight">
                Por Que Nosso Baixador de Áudio <span className="text-[#E6195E]">do Instagram é Melhor</span>
              </h2>
              <p className="text-white/60 text-base sm:text-lg font-medium max-w-3xl mx-auto mt-4">
                Existem muitos extratores de áudio disponíveis. Veja por que os usuários confiam no nosso:
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
              {[
                { icon: <Zap className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Conversão Instantânea", desc: "Servidores otimizados convertem vídeos do Instagram para MP3 em segundos." },
                { icon: <Music className="w-6 h-6 sm:w-8 sm:h-8" />, title: "MP3 em Alta Qualidade", desc: "Baixe áudio do Instagram com som claro e preservação de qualidade." },
                { icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Seguro e Privado", desc: "Não armazenamos URLs do Instagram, nomes de usuário ou dados de conta." },
                { icon: <Smartphone className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Compatível com Todos os Dispositivos", desc: "Baixe áudio do Instagram no Android, iPhone, PC ou Mac." },
                { icon: <Download className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Extração por Link", desc: "Basta colar o link do Instagram para extrair o áudio instantaneamente." },
                { icon: <Infinity className="w-6 h-6 sm:w-8 sm:h-8" />, title: "100% Grátis", desc: "Downloads ilimitados sem assinatura ou taxas ocultas." },
              ].map((feature, i) => (
            ...
            <p className="text-center text-white/50 text-sm sm:text-base font-medium mt-12 max-w-3xl mx-auto">
              Se você procura o melhor site para baixar áudio do Instagram, esta ferramenta oferece velocidade, qualidade e privacidade em um único lugar.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight">
                Compare Nosso Baixador de Áudio <span className="text-[#E6195E]">com Outros Extratores</span>
              </h2>
            </div>

            <div className="overflow-x-auto -mx-4 px-4">
              <table className="w-full min-w-[500px] border-collapse" data-testid="comparison-table-audio">
                <thead>
                  <tr>
                    ...
                    <th className="p-3 sm:p-4 text-xs sm:text-sm font-bold text-[#1A1A1A]/60 bg-[#F8F9FA] rounded-tr-xl border-b border-black/5">Ferramenta Típica</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { feature: "Baixar Áudio", us: "MP3 / Rápido", them: "Básico" },
                    { feature: "Extrair Áudio de Reels", us: "Sim", them: "Limitado" },
                    { feature: "Converter Vídeo para MP3", us: "Sim", them: "Limitado" },
                    { feature: "Baixar Áudio de Story", us: "Sim", them: "Limitado" },
                    { feature: "Pelo Link", us: "Sim", them: "Sim" },
                    { feature: "Sem Login", us: "Sim", them: "Sim" },
                    { feature: "Celular e Desktop", us: "Sim", them: "Sim" },
                    { feature: "Sem Marca d'Água", us: "Sim", them: "Às vezes" },
                  ].map((row, i) => (
            ...
            <p className="text-center text-muted-foreground text-sm sm:text-base font-medium mt-8 max-w-3xl mx-auto">
              Diferente de muitas ferramentas, nosso extrator de áudio do Instagram suporta conversão para MP3, extração de áudio de Reels e Stories, downloads sem marca d'água e processamento seguro via navegador.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-24 md:py-32 bg-[#F8F9FA]" id="faq">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                Perguntas Frequentes Sobre Baixar <span className="text-[#E6195E]">Áudio do Instagram</span>
              </h2>
            </div>
