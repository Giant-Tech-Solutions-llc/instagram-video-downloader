      ...
      <main className="flex-grow">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-[#E6195E]/5 text-[#E6195E] text-[10px] sm:text-xs font-black uppercase tracking-wider mb-4 sm:mb-8 border border-[#E6195E]/10">
                ...
                {"Baixar Foto do Instagram Online Grátis"}
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-3xl mx-auto mb-2 sm:mb-3 font-bold leading-relaxed px-2">
                {"Baixador de Foto do Instagram Grátis – Cole o Link da Foto e Baixe Instantaneamente"}
              </p>
                      ...
                      {processMutation.data.items!.map((item, index) => (
                        <div key={index} className="bg-card rounded-xl sm:rounded-2xl border border-border/60 shadow-lg overflow-hidden">
                          ...
                          <div className="p-2 sm:p-3">
                            <a
                              href={`/api/proxy-download?url=${encodeURIComponent(item.url)}&filename=${encodeURIComponent(item.filename || `instagram-foto-${index + 1}.${item.type === 'video' ? 'mp4' : 'jpg'}`)}`}
                  ...
                  >
                    <div className="md:w-1/2 bg-black/5 relative aspect-video md:aspect-auto min-h-[200px]">
                      {processMutation.data.thumbnail ? (
                        ...
                        <img src={processMutation.data.url} alt="Preview" className="w-full h-full object-cover absolute inset-0" data-testid="img-download-preview" />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center bg-gray-100 text-gray-400">
                    ...
                    <div className="p-6 sm:p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <a
                          href={`/api/proxy-download?url=${encodeURIComponent(processMutation.data.url)}&filename=${encodeURIComponent(processMutation.data.filename || "instagram-foto.jpg")}`}
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {tools.filter(t => t.id !== "foto" && t.slug !== "/").map((t) => (
            ...
            <p className="text-center text-sm sm:text-base text-muted-foreground font-medium mt-6 sm:mt-8">
              {"Tudo funciona diretamente no seu navegador — sem extensões, sem software e sem necessidade de login."}
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-[#F8F9FA]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight mb-4 sm:mb-6">
                {"Baixar Fotos e Imagens do Instagram na"} <span className="text-[#E6195E]">{"Qualidade Original"}</span>
              </h2>
            </div>
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-muted-foreground font-medium leading-relaxed text-center">
              <p>
                {"O Instagram é uma das maiores plataformas de compartilhamento de fotos do mundo. Milhões de imagens são publicadas diariamente — desde fotografias profissionais até momentos pessoais. Muitos usuários desejam baixar fotos do Instagram para salvar offline, usar como referência visual, arquivar publicações ou compartilhar em outras plataformas."}
              </p>
              <p>
                {"No entanto, o Instagram não oferece uma opção nativa para baixar a foto de outra pessoa diretamente no dispositivo."}
              </p>
              <p className="font-bold text-[#1A1A1A]">
                {"Nosso Baixador de Foto do Instagram funciona como uma poderosa ferramenta de download de imagem, permitindo que você:"}
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 my-6 sm:my-8 max-w-2xl mx-auto">
                {[
                  "Baixar foto do Instagram online em HD",
                  "Baixar imagem do Instagram em resolução original",
                  "Salvar foto do Instagram na galeria",
                  "Baixar foto do Instagram sem marca d'água",
                  "Baixar imagens de post do Instagram pelo link",
                  "Baixar foto privada do Instagram (acesso autorizado)",
                  "Extrair imagem JPG em alta qualidade do Instagram",
                  "Baixar fotos do Instagram no PC ou celular",
                ].map((item, i) => (
              ...
              <p>
                {"Se você pesquisou por \"Instagram photo download\", \"baixar foto do Instagram\" ou \"salvar imagem do Instagram\", esta página oferece exatamente a ferramenta que você precisa."}
              </p>
              <p className="font-bold text-[#1A1A1A]">
                {"Basta copiar a URL da publicação do Instagram, colar no nosso baixador e salvar a imagem imediatamente."}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              <span className="text-[#E6195E] font-black uppercase tracking-[0.2em] text-xs sm:text-sm mb-3 sm:mb-4 block">{"Mais do Que um Baixador de Foto do Instagram"}</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight">
                {"Somos uma Plataforma Completa para Baixar"} <span className="text-[#E6195E]">{"Conteúdo do IG"}</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 sm:mt-6 max-w-3xl mx-auto font-medium">
                {"Se você procura mais do que apenas um baixador básico de fotos, nossa plataforma oferece um conjunto completo de ferramentas para baixar, salvar, converter e extrair conteúdos do Instagram com rapidez e segurança."}
              </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                { title: "Baixador de Stories do Instagram", desc: "Baixe Stories antes que expirem. Salve Stories públicos ou baixe Stories privados com acesso autorizado.", slug: "/baixar-stories-instagram" },
                { title: "Baixador de Highlights do Instagram", desc: "Salve Destaques arquivados e Stories antigos em alta resolução.", slug: "/baixar-destaques-instagram" },
                { title: "Baixador de Live do Instagram", desc: "Baixe transmissões ao vivo (Lives) e salve para assistir offline em formato MP4.", slug: "/baixar-live-instagram" },
                { title: "Baixador de Foto de Perfil do Instagram", desc: "Visualize e baixe fotos de perfil em tamanho original e alta qualidade sem precisar fazer login.", slug: "/baixar-foto-perfil-instagram" },
                { title: "Baixador de Carrossel", desc: "Baixe múltiplas fotos e vídeos de um único post carrossel com apenas um clique.", slug: "/baixar-carrossel-instagram" },
                { title: "Baixador de Áudio / MP3 do Instagram", desc: "Baixe o áudio de vídeos ou converta para MP3 facilmente.", slug: "/extrair-audio-instagram" },
                { title: "Baixador de Conteúdo Privado", desc: "Baixe fotos e vídeos privados com acesso autorizado à conta.", slug: "/baixar-conteudo-privado-instagram" },
                { title: "Baixador de Imagem HD & 4K", desc: "Baixe fotos do Instagram em alta resolução sem perda de qualidade.", slug: "/baixar-hd-4k-instagram" },
                { title: "Baixar IGTV do Instagram", desc: "Baixe vídeos longos do IGTV em HD diretamente pelo link.", slug: "/baixar-igtv-instagram" },
                { title: "Baixador de Vídeos do Instagram", desc: "Baixe vídeos tradicionais do Instagram em HD usando apenas o link da publicação.", slug: "/" },
                { title: "Baixar Sem Marca d'Água", desc: "Salve fotos e vídeos sem marca d'água para repostagem ou edição.", slug: "/baixar-sem-marca-dagua-instagram" },
              ].map((item, i) => (
            ...
            <p className="text-center text-sm sm:text-base text-muted-foreground font-medium mt-8 max-w-3xl mx-auto">
              {"Isso torna nosso site uma solução completa para baixar fotos do Instagram, imagens em HD, conteúdo de perfil e muito mais — tudo em um só lugar."}
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                {"Como Baixar Foto"} <span className="text-[#E6195E]">{"do Instagram"}</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 max-w-2xl mx-auto font-medium">
                {"Se você está procurando como baixar fotos do Instagram online, siga estes passos simples:"}
              </p>
            </div>

            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16">
              {[
                { step: "01", title: "Copie a URL da Foto", desc: "Abra o Instagram e selecione a publicação com a foto. Toque nos três pontos e escolha \"Copiar link\"." },
                { step: "02", title: "Cole o Link no Baixador", desc: "Acesse nosso site e cole a URL no campo de download." },
                { step: "03", title: "Clique em Baixar", desc: "Sua foto será processada e estará pronta para download em segundos." },
              ].map((item, i) => (
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
              {[
                ...
                "Baixar imagem no PC",
                "Baixar foto no Android ou iPhone",
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-2xl sm:rounded-[2rem] border border-black/5 p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-black text-[#1A1A1A] mb-4">
                {"Como Baixar Fotos do Instagram no PC, Desktop ou Celular"}
              </h3>
              <p className="text-sm sm:text-base text-muted-foreground font-medium mb-4">
                {"Para baixar fotos do Instagram no celular ou computador:"}
              </p>
              <div className="space-y-2.5">
                {[
                  "Abra o Instagram no aplicativo ou navegador.",
                  "Encontre a publicação com a foto desejada.",
                  "Toque em Compartilhar → Copiar link.",
                  "Abra o navegador e acesse nosso site.",
                  "Cole o link no nosso baixador de foto do Instagram.",
                  "Clique em Baixar e salve a imagem instantaneamente.",
                ].map((step, i) => (
              ...
              <p className="text-sm sm:text-base text-muted-foreground font-medium mt-4">
                {"Funciona em Android, iPhone, tablets e navegadores de desktop."}
              </p>
              <p className="text-sm text-muted-foreground font-bold mt-4 pt-4 border-t border-black/5">
                {"Sem aplicativo. Sem extensão do Chrome. Sem marca d'água adicionada. Sem necessidade de login."}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16 md:mb-24">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black mb-4 sm:mb-6 leading-tight">
                {"Por Que Nosso Baixador de Foto do Instagram"} <span className="text-[#E6195E]">{"se Destaca"}</span>
              </h2>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
              {[
                { icon: <Zap className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Processamento Rápido", desc: "Servidores otimizados garantem downloads instantâneos de fotos." },
                { icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Fotos em Alta Qualidade & HD", desc: "Baixe fotos do Instagram em resolução original, sem compressão." },
                { icon: <Lock className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Seguro e Privado", desc: "Não armazenamos URLs de fotos, dados pessoais ou credenciais de conta." },
                { icon: <Smartphone className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Compatível com PC & Celular", desc: "Baixe fotos do Instagram no PC, desktop, Android ou iPhone." },
                { icon: <Download className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Baixar Foto Pelo Link", desc: "Basta colar o link da publicação e baixar instantaneamente." },
                { icon: <Camera className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Suporte a JPG & Formatos", desc: "Extraia e baixe imagens do Instagram em formatos de alta qualidade." },
                { icon: <Infinity className="w-6 h-6 sm:w-8 sm:h-8" />, title: "100% Grátis", desc: "Downloads ilimitados sem necessidade de cadastro ou assinatura." },
              ].map((feature, i) => (
            ...
            <p className="text-center text-white/40 text-sm sm:text-base font-medium mt-12 sm:mt-16 max-w-3xl mx-auto">
              {"Se você está procurando o melhor site para baixar fotos do Instagram, nossa ferramenta oferece velocidade, qualidade e segurança — tudo gratuitamente."}
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight">
                {"Compare Nosso Baixador de Foto"} <span className="text-[#E6195E]">{"com Outros Downloaders"}</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 max-w-2xl mx-auto font-medium">
                {"Veja como nosso baixador de foto do Instagram se destaca em qualidade, velocidade, recursos e segurança."}
              </p>
            </div>

            <div className="overflow-x-auto -mx-4 px-4">
              <table className="w-full min-w-[500px] border-collapse" data-testid="comparison-table-foto">
                <thead>
                  <tr>
                    ...
                    <th className="p-3 sm:p-4 text-xs sm:text-sm font-bold text-[#1A1A1A]/60 bg-[#F8F9FA] rounded-tr-xl border-b border-black/5">{"Baixador Típico"}</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { feature: "Baixar Foto do Instagram", us: "HD / Rápido", them: "Básico" },
                    { feature: "Imagem Pelo Link", us: "Sim", them: "Sim" },
                    { feature: "Foto em HD", us: "Sim", them: null },
                    { feature: "Foto Privada", us: "Acesso Autorizado", them: null },
                    { feature: "Foto de Perfil", us: "Sim", them: null },
                    { feature: "Sem Login", us: "Sim", them: "Sim" },
                    { feature: "Celular e Desktop", us: "Sim", them: "Sim" },
                  ].map((row, i) => (
            ...
            <p className="text-center text-muted-foreground text-sm sm:text-base font-medium mt-8 max-w-3xl mx-auto">
              {"Diferente de muitas ferramentas, nosso baixador suporta download de fotos em HD, extração de imagem em resolução original, foto de perfil e acesso a fotos privadas autorizadas — tudo em um só lugar."}
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-24 md:py-32 bg-[#F8F9FA]" id="faq">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                {"Perguntas Frequentes Sobre Baixar"} <span className="text-[#E6195E]">{"Fotos do Instagram"}</span>
              </h2>
            </div>
