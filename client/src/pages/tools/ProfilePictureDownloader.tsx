      ...
      <main className="flex-grow">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-[#E6195E]/5 text-[#E6195E] text-[10px] sm:text-xs font-black uppercase tracking-wider mb-4 sm:mb-8 border border-[#E6195E]/10">
                ...
                Baixar Foto de Perfil do Instagram Online Grátis
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-3xl mx-auto mb-2 sm:mb-3 font-bold leading-relaxed px-2">
                Baixador de Foto de Perfil do Instagram Grátis – Visualize, Dê Zoom e Baixe Instantaneamente
              </p>
            ...
            >
              ...
              <div className="mt-4 sm:mt-6 md:mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-black/20">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4 items-center justify-center">
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Dê zoom na Insta DP em tamanho completo</span>
                  <span className="text-black/10">|</span>
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Baixe Instagram PFP em HD</span>
                  <span className="text-black/10">|</span>
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Sem necessidade de login</span>
                  <span className="text-black/10">|</span>
                  <span className="text-[10px] sm:text-xs font-bold text-black/30">Funciona em Android, iPhone, tablet, Windows e Mac</span>
                </div>
              </div>
            </motion.div>
          </div>
                      ...
                      {processMutation.data.items!.map((item, index) => (
                        <div key={index} className="bg-card rounded-xl sm:rounded-2xl border border-border/60 shadow-lg overflow-hidden">
                          ...
                          <div className="p-2 sm:p-3">
                            <a
                              href={`/api/proxy-download?url=${encodeURIComponent(item.url)}&filename=${encodeURIComponent(item.filename || `instagram-profile-picture-${index + 1}.${item.type === 'video' ? 'mp4' : 'jpg'}`)}`}
                    ...
                    <div className="p-6 sm:p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                      <div className="mb-6 sm:mb-8 text-center md:text-left">
                        ...
                        <p className="text-muted-foreground text-sm sm:text-base md:text-lg">
                          Sua foto de perfil foi processada com sucesso e está pronta para baixar.
                        </p>
                      </div>
                      <div className="space-y-3 sm:space-y-4">
                        <a
                          href={`/api/proxy-download?url=${encodeURIComponent(processMutation.data.url)}&filename=${encodeURIComponent(processMutation.data.filename || "instagram-profile-picture.jpg")}`}
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {tools.filter(t => t.id !== "profile-picture" && t.slug !== "/").map((t) => (
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-[#F8F9FA]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight mb-4 sm:mb-6">
                Ver e Baixar Foto de Perfil do Instagram <span className="text-[#E6195E]">em Resolução Completa</span>
              </h2>
            </div>
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-muted-foreground font-medium leading-relaxed text-center">
              <p>
                O Instagram exibe as fotos de perfil como pequenas miniaturas circulares, tornando impossível ver os detalhes completos da imagem. Seja a foto de perfil de um amigo, de um influenciador ou de uma marca, o Instagram limita a visualização a um tamanho reduzido.
              </p>
              <p>
                O Instagram não oferece uma opção para ver a foto de perfil grande ou baixá-la diretamente. Não há botão de zoom, nem opção de download nativo para fotos de perfil.
              </p>
              <p className="font-bold text-[#1A1A1A]">
                Nosso Baixador de Foto de Perfil do Instagram funciona como um visualizador completo de Insta DP, permitindo que você:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 my-6 sm:my-8 max-w-2xl mx-auto">
                {[
                  "Baixar foto de perfil do Instagram online",
                  "Ver foto de perfil do Instagram em tamanho completo",
                  "Dar zoom na imagem de perfil do Instagram",
                  "Salvar foto de perfil do Instagram na galeria",
                  "Baixar avatar do Instagram em resolução original",
                  "Obter Insta DP sem fazer login",
                  "Baixar Instagram PFP em HD",
                  "Extrair foto de perfil de contas públicas do Instagram",
                ].map((item, i) => (
              ...
              <p>
                Se você pesquisou por "download Instagram PFP", "insta dp download", "visualizador de foto de perfil do Instagram" ou "baixar Insta DP em HD", esta página oferece exatamente a ferramenta que você precisa.
              </p>
              <p className="font-bold text-[#1A1A1A]">
                Basta inserir o nome de usuário ou colar o link do perfil, e visualize, dê zoom e baixe a foto de perfil instantaneamente.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              <span className="text-[#E6195E] font-black uppercase tracking-[0.2em] text-xs sm:text-sm mb-3 sm:mb-4 block">Mais do Que um Baixador de Insta DP</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight">
                Somos uma Plataforma Completa de Ferramentas <span className="text-[#E6195E]">para Instagram</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 sm:mt-6 max-w-3xl mx-auto font-medium">
                Nossa plataforma não é apenas um simples visualizador de Insta DP. É uma ferramenta completa para baixar conteúdo do Instagram, cobrindo todos os principais formatos:
              </p>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                { title: "Baixador de Fotos do Instagram", desc: "Baixe publicações com fotos individuais ou coleções de imagens em HD.", slug: "/baixar-fotos-instagram" },
                ...
                { title: "Baixador de Story do Instagram", desc: "Baixe Stories do Instagram em HD antes que desapareçam.", slug: "/baixar-stories-instagram" },
            ...
            <p className="text-center text-muted-foreground text-sm sm:text-base font-medium mt-8 max-w-3xl mx-auto">
              Isso torna nosso site uma solução completa para baixar foto de perfil do Instagram, Insta DP, Instagram PFP e todos os outros tipos de conteúdo do Instagram em uma única plataforma segura.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                Como Baixar Foto de Perfil <span className="text-[#E6195E]">do Instagram</span>
              </h2>
              <p className="text-base sm:text-lg text-muted-foreground mt-4 max-w-2xl mx-auto font-medium">
                Se você está se perguntando como baixar foto de perfil do Instagram online, siga estes passos simples:
              </p>
            </div>

            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16">
              {[
                { step: "01", title: "Copie o Link do Perfil do Instagram ou Nome de Usuário", desc: "Abra o Instagram e acesse o perfil desejado. Copie o link do perfil ou o nome de usuário." },
                { step: "02", title: "Cole no Baixador de Foto de Perfil", desc: "Volte para nossa ferramenta e cole a URL do perfil ou o nome de usuário no campo de download." },
                { step: "03", title: "Clique em Visualizar e Baixar", desc: "A foto de perfil será carregada em tamanho completo e estará pronta para visualizar, dar zoom e baixar." },
              ].map((item, i) => (
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
              {[
                "Ver foto de perfil grande",
                "Dar zoom na Insta DP",
                "Baixar Instagram PFP em HD",
                "Salvar foto na galeria",
                "Obter imagem de contas públicas",
              ].map((item, i) => (
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-2xl sm:rounded-[2rem] border border-black/5 p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-black text-[#1A1A1A] mb-4">
                Como Ver e Salvar Foto de Perfil do Instagram no Celular ou PC
              </h3>
              <p className="text-sm sm:text-base text-muted-foreground font-medium mb-4">
                Para ver e baixar foto de perfil do Instagram sem instalar aplicativo:
              </p>
              <div className="space-y-2.5">
                {[
                  "Abra o aplicativo do Instagram.",
                  "Vá até o perfil desejado.",
                  "Toque nos três pontos do perfil.",
                  "Toque em Copiar URL do Perfil.",
                  "Abra o navegador.",
                  "Cole o link em nosso baixador de foto de perfil.",
                  "Clique em visualizar e baixar.",
                ].map((step, i) => (
              ...
              <p className="text-sm sm:text-base text-muted-foreground font-medium mt-4">
                Compatível com Android, iPhone, Tablets, PC Windows e Mac.
              </p>
              <p className="text-sm text-muted-foreground font-bold mt-4 pt-4 border-t border-black/5">
                Funciona como um baixador de Insta DP, Insta PFP e avatar do Instagram baseado em navegador — rápido, seguro e simples.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16 md:mb-24">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black mb-4 sm:mb-6 leading-tight">
                Por Que Nosso Baixador de Foto de Perfil <span className="text-[#E6195E]">do Instagram é Melhor</span>
              </h2>
              <p className="text-white/60 text-base sm:text-lg font-medium max-w-3xl mx-auto mt-4">
                Existem muitos visualizadores de Insta DP disponíveis. Veja por que os usuários confiam no nosso:
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
              {[
                { icon: <Zap className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Carregamento Instantâneo", desc: "Servidores otimizados garantem visualização imediata em tamanho completo." },
                { icon: <Eye className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Ver Foto Grande", desc: "Abra, amplie e inspecione imagens de perfil em alta resolução." },
                { icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />, title: "HD e Resolução Original", desc: "Baixe foto de perfil do Instagram em HD sem compressão ou redimensionamento." },
                { icon: <Lock className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Seguro e Privado", desc: "Não armazenamos nomes de usuário, links de perfil ou dados de conta." },
                { icon: <Smartphone className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Funciona em Todos os Dispositivos", desc: "Baixe Insta DP no Android, iPhone, tablet ou navegador desktop." },
                { icon: <Link2 className="w-6 h-6 sm:w-8 sm:h-8" />, title: "Suporte a Nome de Usuário e Link", desc: "Baixe foto de perfil usando nome de usuário ou URL do perfil." },
                { icon: <Infinity className="w-6 h-6 sm:w-8 sm:h-8" />, title: "100% Grátis", desc: "Downloads ilimitados sem necessidade de cadastro." },
              ].map((feature, i) => (
            ...
            <p className="text-center text-white/50 text-sm sm:text-base font-medium mt-12 max-w-3xl mx-auto">
              Se você está procurando o melhor site para baixar foto de perfil do Instagram, esta ferramenta oferece velocidade, qualidade e privacidade em um único lugar.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 md:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-[#1A1A1A] leading-tight">
                Compare Nosso Baixador de Foto de Perfil <span className="text-[#E6195E]">com Outras Ferramentas Insta DP</span>
              </h2>
            </div>

            <div className="overflow-x-auto -mx-4 px-4">
              <table className="w-full min-w-[500px] border-collapse" data-testid="comparison-table-profile-picture">
                <thead>
                  <tr>
                    ...
                    <th className="p-3 sm:p-4 text-xs sm:text-sm font-bold text-[#1A1A1A]/60 bg-[#F8F9FA] rounded-tr-xl border-b border-black/5">Visualizador Insta DP Típico</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { feature: "Baixar Foto de Perfil", us: "HD / Tamanho Completo", them: "Básico" },
                    { feature: "Ver Foto Grande", us: "Sim", them: "Limitado" },
                    { feature: "Instagram PFP em HD", us: "Sim", them: "Baixa Qualidade" },
                    { feature: "Insta DP Download", us: "Sim", them: "Sim" },
                    { feature: "Download por Nome de Usuário", us: "Sim", them: "Limitado" },
                    { feature: "Sem Login", us: "Sim", them: "Sim" },
                    { feature: "Celular e Desktop", us: "Sim", them: "Sim" },
                    { feature: "Suporte a Perfil Privado", us: "Acesso Autorizado", them: "Raro" },
                  ].map((row, i) => (
            ...
            <p className="text-center text-muted-foreground text-sm sm:text-base font-medium mt-8 max-w-3xl mx-auto">
              Diferente de muitas ferramentas, nosso baixador de foto de perfil do Instagram suporta visualização em tamanho completo, download em HD, zoom na Insta DP, suporte a nome de usuário e processamento seguro via navegador.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-24 md:py-32 bg-[#F8F9FA]" id="faq">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-10 sm:mb-16 md:mb-20">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-black text-[#1A1A1A] leading-tight">
                Perguntas Frequentes Sobre Baixar <span className="text-[#E6195E]">Foto de Perfil do Instagram</span>
              </h2>
            </div>
