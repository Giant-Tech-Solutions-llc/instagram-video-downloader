...
- **Pages:** Home (main Instagram Video Downloader at `/`), plus 11 dedicated tool landing pages (Reels, Stories, Photos, Profile Picture, Audio/MP3, Highlights, Carousel, Private Content, HD/4K, No Watermark, Live), Terms of Use (`/termos`), Privacy Policy (`/privacidade`), Contact (`/contato`), How it Works (`/como-funciona`), 404 page
